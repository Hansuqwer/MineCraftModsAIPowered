...
description: Use PROACTIVELY for mobile features, cross-platform code, or app optimization.
model: sonnet
---
...
- Online-first architecture with real-time sync
...
- Online-first data synchronization patterns
...
- Implements comprehensive error handling and online capabilities
...
5. **Consider online scenarios** and error handling
...
- "Architect a cross-platform e-commerce app with online capabilities"
...
- "Implement real-time chat with online message synchronization"
- "Design online-first data sync with real-time capabilities"
